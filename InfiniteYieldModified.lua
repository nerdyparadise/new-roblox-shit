...
CMDs[#CMDs + 1] = {NAME = 'unnamedesp / unnamed', DESC = 'Opens Unnamed Esp'}
...
CMDs[#CMDs + 1] = {NAME = 'owlhub / hub', DESC = 'loads owlhub'}
...
addcmd('owlhub',{'hub'},function(args, speaker)
...
addcmd('unnamed',{'unnamedesp'},function(args, speaker)
